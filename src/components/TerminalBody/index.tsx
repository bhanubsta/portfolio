...
const PromptComp: React.FC<PromptCompProps> = ({
  ...
  <div className="Prompt_wrapper">
    <span className="Prompt_user">
      bstbhanu@ubuntu:<span className="Prompt_location">~</span>
...
export const TerminalBox = () => {
  const { text, setText, arrayText, isInputLocked } = zustandStore();
  ...
  return (
    <div className="Terminal_Body">
      <div className="Terminal_Intro">
        <p>
          {
            "Copyright (C) Bhanu Bista Terminal [Version 1.0.0]. All rights reserved."
          }
        </p>
